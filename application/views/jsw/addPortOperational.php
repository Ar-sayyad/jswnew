                            ...
                            <tr>
                                ...
                                <th>
                                    <select id="Month" name="Month" placeholder="Month" required="" class="clsmon form-control">
                                        ...
                                        <option data-id="<?php echo trim($mon['FY_Order']);?>" value="<?php echo trim($mon['MonName']);?>" <?php if($param3==trim($mon['MonName'])){ echo 'selected';}else{}?>><?php echo trim($mon['MonName']);?></option>                                      
                                         <?php }?>  
                                    </select>
                                </th>
                                ...
                                <th>
                                    <select id="year" name="year" placeholder="year" required="" class="form-control">
                                        ...
                                        <option value="<?php echo $pre= date('Y')-1;?>" <?php if($param4==$pre){ echo 'selected';}else{}?>><?php echo date('Y')-1;?></option>
                                        <option value="<?php echo $cur= date('Y');?>" <?php if($param4==$cur){ echo 'selected';}else{}?>><?php echo date('Y');?></option>
                                        <option value="<?php echo $pos= date('Y')+1;?>" <?php if($param4==$pos){ echo 'selected';}else{}?>><?php echo date('Y')+1;?></option>
                                    </select>
                                </th>
                            </tr>
                            <tr>
